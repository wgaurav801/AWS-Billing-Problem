    ...
    public class Ec2InstanceDomainModelGenerator
    {
            ...
            List<Ec2InstanceType> ec2InstanceTypes)
        {
            ...
            var list1 = parsedEc2ResourceUsageTypeEventRecords.Select(
                            record => generateEc2InstanceModel(record.Ec2InstanceId,parsedEc2ResourceUsageTypeEventRecords,record.CustomerId
        ...
        private Ec2Instance generateEc2InstanceModel(string Ec2InstanceId, List<ParsedEc2ResourceUsageEventRecord> parsedEc2ResourceUsageTypeEventRecords, string CustomerId,
